        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <Link href="/" className="flex items-center">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Pixel MP</span>
              </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  <h2 className="mb-6 text-sm font-semibold  uppercase text-white">Want slot?</h2>
                  <ul className="text-white font-medium">
                      <li className="mb-4">
                          <Link href="/buy" className="hover:underline ">Price</Link>
                      </li>
                      <li>
                          <Link href="/buy" className="hover:underline text-white">Buy/Redeem</Link>
                      </li>
                  </ul>
              </div>
              <div>
                  <h2 className="mb-6 text-sm font-semibold  uppercase text-white">Stats</h2>
                  <ul className=" text-white font-medium">
                      <li className="mb-4">
